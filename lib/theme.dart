...
/// Deep Blue color palette for sophisticated, minimalist design
class LightModeColors {
  // Primary: Deep Blue (#2563EB)
  static const lightPrimary = Color(0xFF2563EB);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFDCE7FE);
  static const lightOnPrimaryContainer = Color(0xFF001C3B);

  // Secondary: Light Blue for accents
  static const lightSecondary = Color(0xFF60A5FA);
  static const lightOnSecondary = Color(0xFFFFFFFF);

  // Tertiary: Dark Blue for depth
  static const lightTertiary = Color(0xFF1E40AF);
  ...
  // Surface and background: Clean white with soft greys
  ...
  static const lightGreyLight = Color(0xFFE2E8F0);
}

/// Dark mode with deep blue theme
class DarkModeColors {
  // Primary: Bright blue for dark background
  ...
  static const darkOnPrimaryContainer = Color(0xFFDCE7FE);

  // Secondary: Light blue accent
  static const darkSecondary = Color(0xFF93C5FD);
  static const darkOnSecondary = Color(0xFF00152B);

  // Tertiary: Deep blue for contrast
  static const darkTertiary = Color(0xFF3B82F6);
  ...
  // Additional utility colors
  static const darkGrey = Color(0xFF94A3B8);
  static const darkGreyLight = Color(0xFF64748B);
}
